                ...
                <div class="bg-white dark:bg-slate-800 overflow-hidden shadow-md sm:rounded">
                    <Table>
                            ...
                            <tr v-for="(permission, index) in permissions.data" :key="index"
                                ...
                                <td class="whitespace-nowrap py-4 px-2 sm:py-3">
                                    <div class="flex w-fit rounded overflow-hidden">
                                        <Edit v-show="can(['update permission'])" :title="props.title"
                                            :permission="data.permission" @open="data.permission = permission" />
                                        <Delete v-show="can(['delete permission'])" :title="props.title"
                                            :permission="data.permission" @open="data.permission = permission" />
                                    </div>
                                </td>
                            </tr>
                        ...
                        <template #table-pagination>
                            <TablePagination :links="props.permissions" :filters="data.params" />
                        </template>
                    </Table>
                </div>
            </div>
