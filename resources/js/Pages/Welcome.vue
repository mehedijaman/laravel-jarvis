...
<template>
    ...
    <div
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="mt-16">
                <div
                    ...
                    <div class="flex items-center justify-between">
                        <Link :href="'/'" class="flex justify-items-start items-center space-x-2">
                        <ApplicationLogo class="w-10 h-auto" />
                        <p class="block text-xl font-semibold truncate">
                            {{ $page.props.app.name }}
                        </p>
                        </Link>
                        <SwitchDarkMode />
                    ...
                    <div>
                        <a target="_blank" href="https://github.com/erikwibowo/Laravel-Jarvis.git"
                            class="block mt-6 text-xl font-semibold text-primary">{{ lang().label.documentation }}</a>
            ...
            <div class="flex flex-col md:flex-row items-center mt-8 justify-between gap-2">
                ...
                <div class="text-center text-sm text-slate-500 dark:text-slate-400 sm:text-left">
                    <div class="flex items-center gap-4">
                        <p class="text-slate-600 dark:text-slate-400">
                            {{ $page.props.app.name + " v." + $page.props.app.version }} &copy; {{ new Date().getFullYear()
                            }}.
                            {{ lang().build_with }} <span class="text-rose-500">♥️</span> {{ lang().label.by }}
                            <a class="text-primary font-semibold" target="_blank" href="https://erikwibowo.com">Erik
                                Wibowo</a>
                        </p>
                    </div>
                </div>
