...
<template>
    <div>
        <div
            ...
            <div class="flex justify-start items-center space-x-4 text-2xl md:text-4xl">
                <ApplicationLogo class="w-10 md:w-16 h-10 md:h-16" />
                <p class="text-slate-600 dark:text-white">{{ $page.props.app.name }}</p>
            </div>
        ...
        <div class="bg-slate-200 dark:bg-slate-800 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
            <div>
                <div class="flex items-center">
                    ...
                    <h2 class="ml-3 text-xl font-semibold text-slate-900 dark:text-white">
                ...
                <p class="mt-4 text-sm">
                    <a href="https://laravel.com/docs"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                            class="ml-1 w-5 h-5 fill-primary dark:fill-indigo-200">
