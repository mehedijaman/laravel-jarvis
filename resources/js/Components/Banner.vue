...
<template>
    <div>
        <div v-if="show && message" :class="{ 'bg-primary': style == 'success', 'bg-rose-700': style == 'danger' }">
            <div class="max-w-screen-xl mx-auto py-2 px-3 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between flex-wrap">
                    <div class="w-0 flex-1 flex items-center min-w-0">
                        <span class="flex p-2 rounded"
                            :class="{ 'bg-primary': style == 'success', 'bg-rose-600': style == 'danger' }">
                    ...
                    <div class="shrink-0 sm:ml-3">
                        <button type="button" class="-mr-1 flex p-2 rounded focus:outline-none sm:-mr-2 transition"
                            :class="{ 'hover:bg-primary focus:bg-primary': style == 'success', 'hover:bg-rose-600 focus:bg-rose-600': style == 'danger' }"
