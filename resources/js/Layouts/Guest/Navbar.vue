...
<template>
    ...
    >
            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="shrink-0 flex items-center space-x-2">
                        ...
                        <p
                            class="block sm:hidden text-lg font-semiboldt ext-slate-600 dark:text-white"
                        >
                            {{
        ...
        >
            ...
            <div
                class="pt-4 pb-1 border-t border-slate-200 dark:border-slate-600"
            >
                <div class="flex items-center px-4">
                    ...
                    <div>
                        <div
                            class="font-medium text-base text-slate-800 dark:text-slate-200"
                        >
                            {{ $page.props.auth.user.name }}
                        </div>
