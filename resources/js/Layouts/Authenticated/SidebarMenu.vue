...
<template>
    <div class="text-white">
        ...
        <ol class="pb-24 pt-6 space-y-2">
            ...
            <li v-show="can(['user read'])" v-bind:class="route().current('user.index')
                        ? 'border-l-4 border-white font-semibold bg-white/20 dark:bg-primary/30'
                        : ''
                    " class="hover:bg-white/20 dark:hover:bg-primary/30">
            ...
            <li v-show="can(['role read'])" v-bind:class="route().current('role.index')
                ? 'border-l-4 border-white font-semibold bg-white/20 dark:bg-primary/30'
                : ''
                " class="hover:bg-white/20 dark:hover:bg-primary/30">
            ...
            <li v-show="can(['activity read'])" v-bind:class="route().current('activity.index')
                ? 'border-l-4 border-white font-semibold bg-white/20 dark:bg-primary/30'
                : ''
                " class="hover:bg-white/20 dark:hover:bg-primary/30">

                <Link :href="route('activity.index')" class="flex items-center py-1.5 px-3 space-x-2">
            ...
            <li v-show="can(['logs read'])" v-bind:class="route().current('logs')
                ? 'border-l-4 border-white font-semibold bg-white/20 dark:bg-primary/30'
                : ''
                " class="hover:bg-white/20 dark:hover:bg-primary/30">

                <a href="/logs" class="flex items-center py-1.5 px-3 space-x-2">
                    <ClockIcon class="w-5 h-auto" />
