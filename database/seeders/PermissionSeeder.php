...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Permission::create(['name' => 'permission restore', 'guard_name' => 'web']);
        ...
        Permission::create(['name' => 'setting restore', 'guard_name' => 'web']);
        ...
        Permission::create(['name' => 'activity restore', 'guard_name' => 'web']);
        ...
        Permission::create(['name' => 'logs restore', 'guard_name' => 'web']);
        ...
        Permission::create(['name' => 'app maintenance restore', 'guard_name' => 'web']);
    }
}
